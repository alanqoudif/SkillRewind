...
# SKILLREWIND_DATABASE_URL overrides alembic.ini's sqlalchemy.url so no real
# connection string is ever committed to the repository.
_env_url = os.environ.get("SKILLREWIND_DATABASE_URL")
if _env_url:
