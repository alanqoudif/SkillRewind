...
| Replay/revocation/rebuild/verification/attestation endpoints (spec 8.2) | missing | `revocation.execute` exists only as a job handler (Phase C2), not an API-triggerable workflow yet; this is the next backend gate |
